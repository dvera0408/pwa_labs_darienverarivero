// src/solutions/lab5/Ej4DemoLab5.jsx
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
        ...
        <button className="btn btn-primario" onClick={() => onEditar(id)}>
          Editar
        </button>
...
export default function Ej4DemoLab5() {
  ...
  return (
    <div className="demo-card">
      <p className="muted">
        Prueba "Nueva nota", ver detalle y editar. Todo funciona con estado local y el contexto
        global.
      </p>
      <NotasProvider>
